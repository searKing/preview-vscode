...
export function activate(context: vscode.ExtensionContext) {
    ...
    let registeration: vscode.Disposable;
    ...
    function registerPreviewDocumentContentProvider() {
        ...
        registeration = vscode.workspace.registerTextDocumentContentProvider(PreviewDocumentContentProvider.previewScheme, provider);
    }
    // 调用vscode系统命令预览当前HTML页面
    function sendPreviewCommand(displayColumn: vscode.ViewColumn): void {
    ...
    let previewDisposable = vscode.commands.registerCommand('extension.preview', () => {
        ...
        return sendPreviewCommand(vscode.window.activeTextEditor.viewColumn);
    });
